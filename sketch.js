...
function setup() {
	...
	ground = new Ground(600,450,700,20,ground_options);
...
function draw() {
  rectMode(CENTER);
  background(116, 232, 158);
  ground.display();
  textSize(35)
  fill("black")
  text("Newton's cradle is a device that demonstrates conservation ",1500,100);
  text("of momentum and energy using a series of swinging spheres.",1500,135);
  text("When one sphere at the end is lifted and released, it strikes ",1500,170);
  text("the stationary spheres, transmitting a force through the stationary",1480,205)
  text("spheres that pushes the last sphere upward.",1500,240);
  text("VIEW AT 50% ZOOM IN",1550,600)
  bobobject1.display();
  bobobject2.display();
  bobobject3.display();
  bobobject4.display();
